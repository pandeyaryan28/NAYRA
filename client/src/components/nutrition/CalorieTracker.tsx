    ...
    <div className="p-8 max-w-6xl mx-auto space-y-6 transition-colors duration-150">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <div className="px-3.5 py-1.5 rounded-lg bg-slate-100 dark:bg-zinc-900 border border-slate-200 dark:border-zinc-800 text-xs font-mono text-slate-700 dark:text-zinc-300 shadow-2xs">
          <span>Remaining: </span>
          <strong className="text-slate-900 dark:text-zinc-100">{summary.remainingCalories} kcal</strong>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="p-5 rounded-xl bg-white dark:bg-[#121215] border border-slate-200 dark:border-zinc-800 shadow-2xs space-y-2">
          ...
          <div className="text-2xl font-semibold text-slate-900 dark:text-zinc-100 font-mono">
            {summary.consumedCalories} <span className="text-xs font-normal text-slate-400 dark:text-zinc-500">/ {summary.targetCalories}</span>
          </div>
        ...
        <div className="p-5 rounded-xl bg-white dark:bg-[#121215] border border-slate-200 dark:border-zinc-800 shadow-2xs space-y-2">
          <div className="flex items-center justify-between text-xs text-slate-500 dark:text-zinc-400 font-medium">
            <span>Protein</span>
            <span className="font-mono text-slate-400 dark:text-zinc-500 text-[11px]">{Math.round((summary.consumedProtein / summary.targetProtein) * 100)}%</span>
          </div>
          <div className="text-2xl font-semibold text-slate-900 dark:text-zinc-100 font-mono">
          ...
          <div className="w-full bg-slate-100 dark:bg-zinc-800 rounded-full h-1.5 overflow-hidden">
            <div className="bg-slate-900 dark:bg-zinc-200 h-full rounded-full transition-all duration-300" style={{ width: `${Math.min(100, (summary.consumedProtein / summary.targetProtein) * 100)}%` }}></div>
          </div>
        </div>
        ...
        <div className="p-5 rounded-xl bg-white dark:bg-[#121215] border border-slate-200 dark:border-zinc-800 shadow-2xs space-y-2">
          <div className="flex items-center justify-between text-xs text-slate-500 dark:text-zinc-400 font-medium">
            ...
            <span className="font-mono text-slate-400 dark:text-zinc-500 text-[11px]">{Math.round((summary.consumedCarbs / summary.targetCarbs) * 100)}%</span>
          </div>
          <div className="text-2xl font-semibold text-slate-900 dark:text-zinc-100 font-mono">
            {summary.consumedCarbs}g <span className="text-xs font-normal text-slate-400 dark:text-zinc-500">/ {summary.targetCarbs}g</span>
          </div>
          <div className="w-full bg-slate-100 dark:bg-zinc-800 rounded-full h-1.5 overflow-hidden">
            <div className="bg-slate-900 dark:bg-zinc-200 h-full rounded-full transition-all duration-300" style={{ width: `${Math.min(100, (summary.consumedCarbs / summary.targetCarbs) * 100)}%` }}></div>
          </div>
        </div>
        ...
        <div className="p-5 rounded-xl bg-white dark:bg-[#121215] border border-slate-200 dark:border-zinc-800 shadow-2xs space-y-2">
          <div className="flex items-center justify-between text-xs text-slate-500 dark:text-zinc-400 font-medium">
            <span>Fats</span>
            <span className="font-mono text-slate-400 dark:text-zinc-500 text-[11px]">{Math.round((summary.consumedFat / summary.targetFat) * 100)}%</span>
          </div>
          <div className="text-2xl font-semibold text-slate-900 dark:text-zinc-100 font-mono">
            {summary.consumedFat}g <span className="text-xs font-normal text-slate-400 dark:text-zinc-500">/ {summary.targetFat}g</span>
          </div>
          <div className="w-full bg-slate-100 dark:bg-zinc-800 rounded-full h-1.5 overflow-hidden">
            <div className="bg-slate-900 dark:bg-zinc-200 h-full rounded-full transition-all duration-300" style={{ width: `${Math.min(100, (summary.consumedFat / summary.targetFat) * 100)}%` }}></div>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 p-6 rounded-xl bg-white dark:bg-[#121215] border border-slate-200 dark:border-zinc-800 shadow-2xs space-y-4">
          <div className="flex items-center justify-between">
            <h3 className="text-sm font-semibold text-slate-900 dark:text-zinc-100">Meals Today</h3>
        ...
        <div className="p-6 rounded-xl bg-white dark:bg-[#121215] border border-slate-200 dark:border-zinc-800 shadow-2xs space-y-4">
          <div className="flex items-center justify-between">
            ...
            <span className="text-xs font-mono font-semibold text-slate-900 dark:text-zinc-100">{summary.waterIntakeMl} ml</span>
          </div>

          <div className="w-full bg-slate-100 dark:bg-zinc-800 rounded-full h-2 overflow-hidden">
            <div
              className="bg-slate-900 dark:bg-zinc-200 h-full rounded-full transition-all duration-300"
          ...
          <div className="grid grid-cols-2 gap-2">
            <button
              ...
              className="py-2 rounded-lg bg-slate-100 hover:bg-slate-200 dark:bg-zinc-800 dark:hover:bg-zinc-700 text-slate-800 dark:text-zinc-200 text-xs font-medium transition-colors cursor-pointer shadow-2xs"
            >
              +250ml Glass
            </button>
            <button
