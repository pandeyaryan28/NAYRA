import type { FoodItem, MealEntry } from '../types/index.js';
...
const FOOD_DATABASE: NutritionRef[] = [
  { keywords: ['egg', 'eggs', 'boiled egg', 'fried egg', 'omelette', 'scrambled egg'], unitCalories: 78, unitProtein: 6.3, unitCarbs: 0.6, unitFat: 5.3, defaultUnit: 'piece' },
  ...
  { keywords: ['chicken breast', 'grilled chicken', 'cooked chicken', 'chicken'], unitCalories: 165, unitProtein: 31.0, unitCarbs: 0.0, unitFat: 3.6, defaultUnit: '100g' },
  ...
  { keywords: ['almond milk', 'oat milk', 'soy milk'], unitCalories: 45, unitProtein: 1.5, unitCarbs: 2.0, unitFat: 3.0, defaultUnit: '1 cup' },
  ...
  { keywords: ['green tea', 'tea', 'black tea', 'chai'], unitCalories: 2, unitProtein: 0.1, unitCarbs: 0.4, unitFat: 0.0, defaultUnit: '1 cup' },
  { keywords: ['almonds', 'nuts', 'mixed nuts', 'cashew', 'walnuts'], unitCalories: 160, unitProtein: 6.0, unitCarbs: 6.0, unitFat: 14.0, defaultUnit: 'handful (28g)' },
